...
export default function About() {
    ...
    return (
        <section className="px-6 lg:px-6 py-16 lg:py-32 max-w-[1400px] mx-auto">
            <div className="flex flex-col lg:flex-row gap-16 lg:gap-5 items-center">
                {/* Left Side: Images */}
                <div className="relative w-full lg:w-1/2 min-h-[450px]">
                    ...
                    <div className="absolute top-[35%] lg:top-[25%] left-[55%] lg:left-[65%] z-20 w-[140px] h-[140px] bg-primary rounded-full flex flex-col items-center justify-center shadow-lg border-[6px] border-white transform -translate-x-1/2 -translate-y-1/2">
                        <div className="relative w-full h-full flex items-center justify-center">
                            ...
                            <div className="w-[64px] h-[64px] bg-[#bede7a] rounded-full flex items-center justify-center shadow-sm">
                                <img src={`/home/vector.svg`} width={`28px`} alt='BioCer' />
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div className="w-full lg:w-1/2 flex flex-col items-start pt-8 lg:pt-0">
                    <div className="flex items-center gap-2 mb-4">
                        ...
                        <span className="text-gray-500 text-sm font-medium">About Us</span>
                    </div>

                    <h2 className="text-3xl lg:text-3xl font-medium text-gray-800 mb-6 leading-tight max-w-lg">
                        About BioCer Entwicklungs-GmbH
                    </h2>

                    <p className="text-gray-500 mb-10 text-[15px] leading-relaxed max-w-xl">
                        BioCer develops new materials and implements them in innovative medical
                        devices. We are specialized in research, development and production of
                        innovative, biocompatible medical devices without animal or human
                        components. Do you have an idea for a new medical product that you want to
                        bring to market? Make use of our team and our know-how. After all, we not
                        only develop and produce in-house, but also on behalf of customers.
                        Please contact us!
                    </p>
